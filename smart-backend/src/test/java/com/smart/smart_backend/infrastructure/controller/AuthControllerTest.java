...
class AuthControllerTest {
    ...
    void login_WhenValidCredentials_ShouldReturnTokenAndSetCookie() throws Exception {
        ...
        mockMvc.perform(post("/api/auth/login")
                ...
                .andExpect(header().string(HttpHeaders.SET_COOKIE, containsString("refreshToken=refresh-uuid")))
    ...
    void refresh_WhenValidCookie_ShouldReturnNewToken() throws Exception {
        ...
        mockMvc.perform(post("/api/auth/refresh")
                ...
                .andExpect(header().string(HttpHeaders.SET_COOKIE, containsString("refreshToken=new-refresh-uuid")));
    }
