...
public class StudyLog {
    ...
    public void validate(Float hours){
        if(hours!=null && hours<0.1 || hours != null && hours > 12){ // 0.1 equivaldría a 10' ? sería un caso feo pero posible
...
— son entidades relacionadas que conocen tanto al Habit (definición) como al DailyEntry (día).
 */